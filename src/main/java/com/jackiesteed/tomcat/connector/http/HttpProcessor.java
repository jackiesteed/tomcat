...
import com.jackiesteed.tomcat.ServletProcessor;
import com.jackiesteed.tomcat.StaticResourceProcessor;
...
public class HttpProcessor {
    ...
    protected StringManager sm =
            StringManager.getManager("com.jackiesteed.tomcat.connector.http");
    ...
    public void process(Socket socket) {
        ...
        try {
            ...
            response.setHeader("Server", "Tomcat Servlet Container");
